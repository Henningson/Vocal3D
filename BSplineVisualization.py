...
def visualizeSingleBM5(bm5, points, zSubdivisions):
    ...
    for i in range(bm5.shape[0]):
        ...
        if i == 0:
            ...
            surfaces.vis.add(geodesic, "geodesic", name="Geodesic Right", color="#333333")
            component.render(display_plot=True, fig_save_as="frame{0:05d}.png".format(i))
